...
int main()
{
	...
	Shader objectShader("../src/shaders/vertex_shader_basic_lighting.vs", "../src/shaders/fragment_shader_basic_lighting.fs");
	Shader lightShader("../src/shaders/vertex_shader_basic_lighting.vs", "../src/shaders/fragment_shader_light_lighting.fs");
