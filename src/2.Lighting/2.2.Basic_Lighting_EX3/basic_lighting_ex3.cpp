...
int main()
{
	...
	Shader objectShader("../src/shaders/vertex_shader_basic_lighting_ex3.vs", "../src/shaders/fragment_shader_basic_lighting_ex3.fs");
	Shader lightShader("../src/shaders/vertex_shader_basic_lighting_ex3.vs", "../src/shaders/fragment_shader_light_lighting.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		objectShader.setVec3("aLightPos", lightPos);
