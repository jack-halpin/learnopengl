...
int main()
{
	...
	Shader shader(createShaderPath("2.1.Stencil_Testing.vs").c_str(), createShaderPath("2.1.Stencil_Testing.fs").c_str());
	Shader borderShader(createShaderPath("2.1.Stencil_Testing.vs").c_str(), createShaderPath("2.1.Stencil_Testing_border.fs").c_str());
