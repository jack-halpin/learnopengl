...
int main()
{
	...
	Shader shaderProgram("../src/shaders/refresher_vertex_shader.vs", "../src/shaders/refresher_fragment_shader.fs");
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(ltVertices), ltVertices, GL_STATIC_DRAW);
